...
var HelixModerationApi = /** @class */ (function (_super) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._client.callApi({
                            ...
                            query: tslib_1.__assign({ broadcaster_id: UserTools_1.extractUserId(channel), user_id: filter === null || filter === void 0 ? void 0 : filter.userId }, HelixPagination_1.makePaginationQuery(filter))
                        })];
                    case 1:
                        result = _a.sent();
    ...
    HelixModerationApi.prototype.getBannedUsersPaginated = function (channel) {
        ...
        }, this._client, function (data) { return new HelixBan_1.HelixBan(data, _this._client); });
    };
    /**
