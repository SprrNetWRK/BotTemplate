...
var ApiClient = /** @class */ (function () {
    ...
    function ApiClient(config) {
        ...
        if (!authProvider) {
            throw new ConfigError_1.ConfigError('No auth provider given');
        }
        this._helixRateLimiter = new HelixRateLimiter_1.HelixRateLimiter(config.logLevel || logger_1.LogLevel.CRITICAL);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.callApi({ type: twitch_api_call_1.TwitchApiCallType.Auth, url: 'validate' })];
                    case 1:
                        data = _a.sent();
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        accessToken = _b;
                        if (!accessToken) {
                            return [2 /*return*/, twitch_api_call_1.callTwitchApi(options, authProvider.clientId)];
                        }
    ...
    ApiClient.prototype._callApiInternal = function (options, clientId, accessToken) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                if (options.type === twitch_api_call_1.TwitchApiCallType.Helix) {
