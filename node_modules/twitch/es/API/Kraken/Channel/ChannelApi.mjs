        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1: return [2 /*return*/, new (_a.apply(PrivilegedChannel, [void 0, _b.sent(), this._client]))()];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, data.follows.map(function (followData) { return new ChannelFollow(followData, _this._client); })];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2: return [2 /*return*/, new (_a.apply(ChannelSubscription, [void 0, _b.sent(), this._client]))()];
                    case 3:
                        e_1 = _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, data.teams.map(function (teamData) { return new Team(teamData, _this._client); })];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        channelData = _a.sent();
                        return [2 /*return*/, new PrivilegedChannel(channelData, this._client)];
                }
            });
        });
    };
