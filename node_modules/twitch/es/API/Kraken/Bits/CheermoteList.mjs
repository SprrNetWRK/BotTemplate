...
var CheermoteList = /** @class */ (function () {
    ...
    function CheermoteList(data, client) {
        this._client = client;
        this._data = indexBy(data, function (action) { return action.prefix.toLowerCase(); });
    }
    /**
    ...
    CheermoteList.prototype.getCheermoteDisplayInfo = function (name, bits, format) {
        ...
        var fullOptions = __assign({ background: cheermoteDefaults.defaultBackground, state: cheermoteDefaults.defaultState, scale: cheermoteDefaults.defaultScale }, format);
