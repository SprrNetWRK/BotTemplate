...
var HelixPaginatedRequest = /** @class */ (function () {
    ...
    HelixPaginatedRequest.prototype._fetchData = function (additionalOptions) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._client.callApi(__assign(__assign(__assign({ type: TwitchApiCallType.Helix }, this._callOptions), additionalOptions), { query: __assign(__assign(__assign({}, this._callOptions.query), { after: this._currentCursor, first: '100' }), additionalOptions.query) }))];
            });
        });
    };
    /** @private */
