...
var HelixWebHooksApi = /** @class */ (function (_super) {
    ...
    HelixWebHooksApi.prototype.getSubscriptions = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new HelixPaginatedRequestWithTotal({
                        url: 'webhooks/subscriptions'
                    }, this._client, function (data) { return new HelixWebHookSubscription(data, _this._client); })];
            });
        });
    };
    /**
    ...
    HelixWebHooksApi.prototype._sendUserFollowsHubRequest = function (mode, direction, user, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.sendHubRequest(__assign({ mode: mode, topicUrl: "https://api.twitch.tv/helix/users/follows?first=1&" + direction + "_id=" + userId }, options))];
            });
        });
    };
    HelixWebHooksApi.prototype._sendStreamChangeHubRequest = function (mode, user, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                userId = extractUserId(user);
                return [2 /*return*/, this.sendHubRequest(__assign({ mode: mode, topicUrl: "https://api.twitch.tv/helix/streams?user_id=" + userId }, options))];
            });
        });
    };
    HelixWebHooksApi.prototype._sendUserChangeHubRequest = function (mode, user, options, withEmail) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                userId = extractUserId(user);
                return [2 /*return*/, this.sendHubRequest(__assign({ mode: mode, topicUrl: "https://api.twitch.tv/helix/users?id=" + userId, scope: withEmail ? 'user:read:email' : undefined }, options))];
            });
        });
    };
    HelixWebHooksApi.prototype._sendSubscriptionEventsHubRequest = function (mode, user, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                userId = extractUserId(user);
                return [2 /*return*/, this.sendHubRequest(__assign({ mode: mode, topicUrl: "https://api.twitch.tv/helix/subscriptions/events?broadcaster_id=" + userId + "&first=1", scope: 'channel:read:subscriptions' }, options))];
            });
        });
    };
    HelixWebHooksApi.prototype._sendExtensionTransactionsHubRequest = function (mode, extensionId, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.sendHubRequest(__assign({ mode: mode, topicUrl: "https://api.twitch.tv/helix/extensions/transactions?extension_id=" + extensionId + "&first=1" }, options))];
            });
        });
    };
    HelixWebHooksApi.prototype._sendBanEventsHubRequest = function (mode, broadcaster, options, user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.sendHubRequest(__assign({ mode: mode,
