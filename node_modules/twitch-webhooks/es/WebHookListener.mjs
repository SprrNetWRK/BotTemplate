...
import { LegacyAdapter } from "./Adapters/LegacyAdapter.mjs";
import { BanEventSubscription } from "./Subscriptions/BanEventSubscription.mjs";
import { ExtensionTransactionSubscription } from "./Subscriptions/ExtensionTransactionSubscription.mjs";
import { FollowsFromUserSubscription } from "./Subscriptions/FollowsFromUserSubscription.mjs";
import { FollowsToUserSubscription } from "./Subscriptions/FollowsToUserSubscription.mjs";
import { ModeratorEventSubscription } from "./Subscriptions/ModeratorEventSubscription.mjs";
import { StreamChangeSubscription } from "./Subscriptions/StreamChangeSubscription.mjs";
import { SubscriptionEventSubscription } from "./Subscriptions/SubscriptionEventSubscription.mjs";
import { UserChangeSubscription } from "./Subscriptions/UserChangeSubscription.mjs";
/**
...
var WebHookListener = /** @class */ (function () {
     ...
     * @param config
     */
    function WebHookListener(apiClient, adapter, config) {
        ...
        this._logger = new Logger(__assign({ name: 'twitch-webhooks', emoji: true }, ((_a = config.logger) !== null && _a !== void 0 ? _a : {})));
    }
    /**
     * Creates a new WebHook listener.
     *
     ...
     * @param config
     */
    WebHookListener.create = function (apiClient, config) {
        if (config === void 0) { config = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var adapter;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, LegacyAdapter.create(config)];
                    case 1:
                        adapter = _a.sent();
                        return [2 /*return*/, new WebHookListener(apiClient, adapter, config)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        subscription = new UserChangeSubscription(userId, handler, withEmail, this, validityInSeconds);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userId = extractUserId(user);
                        subscription = new FollowsToUserSubscription(userId, handler, this, validityInSeconds);
                        return [4 /*yield*/, subscription.start()];
                    case 1:
                        _a.sent();
                        this._subscriptions.set(subscription.id, subscription);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userId = extractUserId(user);
                        subscription = new FollowsFromUserSubscription(userId, handler, this, validityInSeconds);
                        return [4 /*yield*/, subscription.start()];
                    case 1:
                        _a.sent();
                        this._subscriptions.set(subscription.id, subscription);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userId = extractUserId(user);
                        subscription = new StreamChangeSubscription(userId, handler, this, validityInSeconds);
                        return [4 /*yield*/, subscription.start()];
                    case 1:
                        _a.sent();
                        this._subscriptions.set(subscription.id, subscription);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userId = extractUserId(user);
                        subscription = new SubscriptionEventSubscription(userId, handler, this, validityInSeconds);
                        return [4 /*yield*/, subscription.start()];
                    case 1:
                        _a.sent();
                        this._subscriptions.set(subscription.id, subscription);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        subscription = new BanEventSubscription(broadcasterId, handler, this, userId, validityInSeconds);
                        return [4 /*yield*/, subscription.start()];
                    case 1:
                        _a.sent();
                        this._subscriptions.set(subscription.id, subscription);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        broadcasterId = extractUserId(broadcaster);
                        userId = user ? extractUserId(user) : undefined;
                        subscription = new ModeratorEventSubscription(broadcasterId, handler, this, userId, validityInSeconds);
                        return [4 /*yield*/, subscription.start()];
                    case 1:
                        _a.sent();
                        this._subscriptions.set(subscription.id, subscription);
    ...
    WebHookListener.prototype.subscribeToExtensionTransactions = function (extensionId, handler, validityInSeconds) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        subscription = new ExtensionTransactionSubscription(extensionId, handler, this, validityInSeconds);
                        return [4 /*yield*/, subscription.start()];
                    case 1:
                        _a.sent();
                        this._subscriptions.set(subscription.id, subscription);
