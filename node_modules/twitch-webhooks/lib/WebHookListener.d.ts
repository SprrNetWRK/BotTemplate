...
import type { ApiClient, HelixBanEvent, HelixExtensionTransaction, HelixFollow, HelixModeratorEvent, HelixStream, HelixSubscriptionEvent, HelixUser, UserIdResolvable } from 'twitch';
...
export declare class WebHookListener {
     ...
     * This is meant for debugging issues. Please don't set it unless you know what you're doing.
     */
    subscribeToSubscriptionEvents(user: UserIdResolvable, handler: (subscriptionEvent: HelixSubscriptionEvent) => void, validityInSeconds?: number | undefined): Promise<Subscription>;
    /**
