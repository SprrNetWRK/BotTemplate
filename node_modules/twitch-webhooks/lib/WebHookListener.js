...
var WebHookListener = /** @class */ (function () {
    ...
    function WebHookListener(apiClient, adapter, config) {
        ...
        this._logger = new logger_1.Logger(tslib_1.__assign({ name: 'twitch-webhooks', emoji: true }, ((_a = config.logger) !== null && _a !== void 0 ? _a : {})));
    }
    /**
     * Creates a new WebHook listener.
     *
    ...
    WebHookListener.create = function (apiClient, config) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, LegacyAdapter_1.LegacyAdapter.create(config)];
                    case 1:
                        adapter = _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        subscription = new UserChangeSubscription_1.UserChangeSubscription(userId, handler, withEmail, this, validityInSeconds);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userId = twitch_1.extractUserId(user);
                        subscription = new FollowsToUserSubscription_1.FollowsToUserSubscription(userId, handler, this, validityInSeconds);
                        return [4 /*yield*/, subscription.start()];
                    case 1:
                        _a.sent();
                        this._subscriptions.set(subscription.id, subscription);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userId = twitch_1.extractUserId(user);
                        subscription = new FollowsFromUserSubscription_1.FollowsFromUserSubscription(userId, handler, this, validityInSeconds);
                        return [4 /*yield*/, subscription.start()];
                    case 1:
                        _a.sent();
                        this._subscriptions.set(subscription.id, subscription);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userId = twitch_1.extractUserId(user);
                        subscription = new StreamChangeSubscription_1.StreamChangeSubscription(userId, handler, this, validityInSeconds);
                        return [4 /*yield*/, subscription.start()];
                    case 1:
                        _a.sent();
                        this._subscriptions.set(subscription.id, subscription);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userId = twitch_1.extractUserId(user);
                        subscription = new SubscriptionEventSubscription_1.SubscriptionEventSubscription(userId, handler, this, validityInSeconds);
                        return [4 /*yield*/, subscription.start()];
                    case 1:
                        _a.sent();
                        this._subscriptions.set(subscription.id, subscription);
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        subscription = new BanEventSubscription_1.BanEventSubscription(broadcasterId, handler, this, userId, validityInSeconds);
                        return [4 /*yield*/, subscription.start()];
                    case 1:
                        _a.sent();
                        this._subscriptions.set(subscription.id, subscription);
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        broadcasterId = twitch_1.extractUserId(broadcaster);
                        userId = user ? twitch_1.extractUserId(user) : undefined;
                        subscription = new ModeratorEventSubscription_1.ModeratorEventSubscription(broadcasterId, handler, this, userId, validityInSeconds);
                        return [4 /*yield*/, subscription.start()];
                    case 1:
                        _a.sent();
                        this._subscriptions.set(subscription.id, subscription);
    ...
    WebHookListener.prototype.subscribeToExtensionTransactions = function (extensionId, handler, validityInSeconds) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        subscription = new ExtensionTransactionSubscription_1.ExtensionTransactionSubscription(extensionId, handler, this, validityInSeconds);
                        return [4 /*yield*/, subscription.start()];
                    case 1:
                        _a.sent();
                        this._subscriptions.set(subscription.id, subscription);
